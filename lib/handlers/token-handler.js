...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  if (this.isClientAuthenticationRequired(grantType) && !credentials.clientSecret && !request.body.code_verifier) {
...
TokenHandler.prototype.getClientCredentials = function(request) {
  ...
  if (!this.isClientAuthenticationRequired(grantType) || request.body.code_verifier) {
